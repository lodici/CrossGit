...
class SortButtonBar {
    ...
    SortButtonBar(BranchesPane listener) {
        ...
        btn1.setUserData(BranchSortOrder.NAME);
        btn1.setGraphic(ResourceHelper.getImage("sort-alpha-16.png"));
        btn1.setToggleGroup(tg);
        btn1.setSelected(BranchSortOrder.isEqualTo(BranchSortOrder.NAME));

        RadioButton btn2 = new ToggleRadioButton();
        btn2.setUserData(BranchSortOrder.NAME_REVERSED);
        btn2.setGraphic(ResourceHelper.getImage("sort-alpha-reversed-16.png"));
        btn2.setToggleGroup(tg);
        btn2.setSelected(BranchSortOrder.isEqualTo(BranchSortOrder.NAME_REVERSED));

        RadioButton btn3 = new ToggleRadioButton();
        btn3.setUserData(BranchSortOrder.DATETIME);
        ...
        btn3.setSelected(BranchSortOrder.isEqualTo(BranchSortOrder.DATETIME));

        RadioButton btn4 = new ToggleRadioButton();
        btn4.setUserData(BranchSortOrder.DATETIME_REVERSED);
        ...
        btn4.setSelected(BranchSortOrder.isEqualTo(BranchSortOrder.DATETIME_REVERSED));

        tg.selectedToggleProperty().addListener(new ChangeListener<Toggle>() {
            @Override
            public void changed(ObservableValue<? extends Toggle> observable, Toggle oldValue, Toggle newValue) {
                BranchSortOrder.setValue((BranchSortOrder) newValue.getUserData());
                listener.setSortOrder(BranchSortOrder.getValue());
            }
        });
